...
def webscrapeCareerStats(name, playerNameDictionary, batting_file, pitching_file):
    batters_list = []
    pitchers_list = []
    batters_headers = ['Player Name', 'G', 'AB', 'R', 'H', '2B', '3B', 'HR', 'RBI', 'BB', 'IBB', 'SO', 'HBP', 'SH',
                       'SF', 'XI', 'ROE',
                       'GDP', 'SB', 'CS', 'AVG', 'OBP', 'SLG', 'BFW']

    pitchers_headers = ['Player Name', 'G', 'GS', 'CG', 'SHO', 'GF', 'SV', 'IP', 'H', 'BFP', 'HR', 'R', 'ER', 'BB',
                        'IB', 'SO', 'SH',
